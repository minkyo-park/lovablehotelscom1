...
const DiscountCodes = () => {
  const jsonLd = {
    ...
    "@type": "Article",
    headline: "2026년 8월 호텔스닷컴 할인코드 전체 모음",
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container-content section-padding !py-16 md:!py-24">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-2xl">
            2026년 8월 기준, 검증된 모든 호텔스닷컴 할인코드를 상세히 분석하고 비교합니다.
      ...
      <section className="section-padding">
        <div className="container-content">
          ...
          {/* AUGUST15 Detail — 역대 최대 */}
          <article className="mb-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              <img src={codeNpay10} alt="AUGUST15 할인코드 15% 할인" className="rounded-xl card-shadow w-full" loading="lazy" />
              <div>
                <span className="discount-badge mb-3">👑 역대 최대 15%</span>
                <h3 className="text-xl md:text-2xl font-black text-foreground mb-3">
                  ⭐ AUGUST15 — 전 지역 숙소 15% 할인 (역대 최대!)
                </h3>
                <p className="text-muted-foreground mb-4 leading-relaxed">
                  AUGUST15는 호텔스닷컴이 제공한 역대 최대 할인율(15%)의 코드로, 전 지역 숙소에 적용됩니다.
                  최대 7만 원까지 할인되며, 8월 한 달간만 발급되는 한정 코드입니다.
                  올해 12월 말까지 투숙이 가능해 여름·가을·연말 여행을 모두 미리 예약할 수 있습니다.
                </p>
                <div className="table-responsive mb-4">
                  <table className="w-full text-sm border-collapse">
                    <tbody>
                      <tr className="border-b border-border"><td className="p-2 font-semibold text-foreground">할인코드</td><td className="p-2 font-mono font-bold text-primary">AUGUST15</td></tr>
                      ...
                      <tr className="border-b border-border"><td className="p-2 font-semibold text-foreground">예약 기간</td><td className="p-2 text-muted-foreground">2026년 8월 1일 ~ 8월 31일</td></tr>
                ...
                <CopyCodeButton code="AUGUST15" label="AUGUST15 복사 & 적용" variant="large" href={EXCLUSIVE_LINK} />
              </div>
            </div>
          </article>
          ...
          <article className="mb-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4 leading-relaxed">
                  8월에 발급된 네이버페이 전용 코드는 올해 12월 31일까지 투숙이 가능해,
          ...
          <article className="mb-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              ...
              <div className="md:order-1">
                ...
                <p className="text-muted-foreground mb-4 leading-relaxed">
                  DT26는 2026년 8월 기준으로 확인된 전 세계 적용 기본 코드입니다.
      ...
      <section className="section-padding bg-card">
        <div className="container-content">
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ...
                  ["추천 상황", "8월 예약 최적", "장기 선예약", "소액 예약", "대안 코드"],
                ].map((row, i) => (
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            {[
              { scenario: "8월 내 해외 호텔 예약", code: "NPAY10", reason: "가장 높은 10% 할인율. 네이버페이 필수." },
