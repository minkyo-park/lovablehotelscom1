...
const Index = () => {
  const jsonLd = {
    ...
    "@type": "WebSite",
    name: "호텔스닷컴 할인코드 및 쿠폰 9월",
    url: "https://lvhts.agd-offer.co.kr",
    description: "2026년 9월 최신 호텔스닷컴 할인코드 및 쿠폰 총정리. 네이버페이 10% 할인, 카드사 프로모션, 최대 20% 할인 쿠폰 코드를 확인하세요.",
    potentialAction: {
      "@type": "SearchAction",
        ...
        <div className="container-content">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { icon: Shield, label: "검증 코드", value: "4개+", desc: "2026년 9월" },
            ].map((stat) => (
        ...
        <div className="container-content">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            ...
            <DiscountCodeCard
              ...
              description="전 세계 호텔 10% 즉시 할인. 9월에 발급된 네이버페이 전용 코드로 여름휴가나 추석 연휴 여행을 미리 예약하기에 최적입니다."
        ...
        <div className="container-content">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              {[
                { icon: TrendingUp, title: "9월 내 해외 호텔 예약", desc: "NPAY10(10%) → 현재 최고 할인율. 네이버페이 결제 시 즉시 적용." },
